...
public class BooksPage extends PageObject {
	...
	public void selectBook(String bookName) {
		String booknamelinkXpath=replaceWithValue(booknamelink,bookName);
	...
	public void selectedBookDisplayed(String bookName) {
		assertExists(replaceWithValue(selectedbookheader,bookName));
	}
